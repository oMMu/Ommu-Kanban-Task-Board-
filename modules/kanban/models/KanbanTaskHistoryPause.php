<?php
/**
 * KanbanTaskHistoryPause * @author Putra Sudaryanto <putra.sudaryanto@gmail.com>
 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_kanban_task_history_pause".
 *
 * The followings are the available columns in table 'ommu_kanban_task_history_pause':
 ...
 */
class KanbanTaskHistoryPause extends CActiveRecord
{
	 ...
	 * @return KanbanTaskHistoryPause the static model class
	 */
	...
	{
		return 'ommu_kanban_task_history_pause';
	}
	...
	public function rules()
	{
		...
		return array(
			array('task_id, pause_condition', 'required'),
			array('task_id', 'length', 'max'=>11),
			array('pause_date, unpause_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('pause_id, task_id, pause_date, pause_condition, unpause_date', 'safe', 'on'=>'search'),
		);
	}
	...
	*/
	...
	protected function beforeSave() {
		if(parent::beforeSave()) {
			//$this->pause_date = date('Y-m-d', strtotime($this->pause_date));
			//$this->unpause_date = date('Y-m-d', strtotime($this->unpause_date));
		}
		return true;	
	}
	*/
