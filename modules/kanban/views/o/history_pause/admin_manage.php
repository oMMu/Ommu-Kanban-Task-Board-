...
<?php $this->renderPartial('/o/history_pause/_search',array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Search ?>
...
<div class="grid-form">
<?php $this->renderPartial('/o/history_pause/_option_form',array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Grid Option ?>

<div id="partial-kanban-task-history-pause">
	<?php //begin.Messages ?>
	<div id="ajax-message">
	<?php
	...
	<div class="boxed">
		...
		<?php 
			...
			$this->widget('application.components.system.OGridView', array(
				'id'=>'kanban-task-history-pause-grid',
